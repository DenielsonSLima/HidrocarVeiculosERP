...
const CardPendenciasUrgentes: React.FC = () => {
  return (
       ...
       <div className="space-y-6">
          <div className="flex items-start space-x-4 p-5 bg-rose-50 rounded-3xl border border-rose-100">
             ...
             <div>
                ...
                <p className="text-xl font-black text-rose-900">R$ 1.450,00</p>
                <p className="text-[9px] text-rose-400 font-bold uppercase mt-1">2 Títulos vencidos</p>
             </div>
          </div>
          ...
          <div className="flex items-start space-x-4 p-5 bg-amber-50 rounded-3xl border border-amber-100">
             ...
             <div>
                ...
                <p className="text-xl font-black text-amber-900">R$ 3.890,20</p>
                <p className="text-[9px] text-amber-400 font-bold uppercase mt-1">Aguardando baixa</p>
             </div>
          </div>
       </div>
