...
const DespesaVariavelForm: React.FC<Props> = ({ onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white w-full max-w-lg rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 border border-slate-100">
        {/* Header */}
        <div className="p-8 border-b border-slate-50 bg-orange-600 text-white">
          <h3 className="text-xl font-black uppercase tracking-tighter">Lançar Despesa Variável</h3>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 border-2 border-orange-100 rounded-2xl px-5 py-3.5 text-lg font-black text-orange-600 outline-none focus:border-orange-500 text-center"
                required
              />
            </div>
          </div>
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <button
              type="submit"
              disabled={isSaving}
              className="flex-1 py-4 bg-orange-600 text-white font-black text-xs uppercase tracking-widest rounded-2xl shadow-lg hover:bg-orange-700 transition-all flex items-center justify-center"
            >
