          ...
          {rows.map((t) => (
            <tr key={t.id} className="hover:bg-slate-50/50 transition-colors group">
              ...
              <td className="px-8 py-6">
                ...
                {t.pedido_venda && (
                   <button onClick={() => navigate(`/pedidos-venda/${t.pedido_venda?.id}`)} className="flex items-center mt-1 text-[9px] font-black text-emerald-500 hover:text-emerald-700 uppercase tracking-tighter">
                     ...
                     Venda #{t.pedido_venda.numero_venda}
                   </button>
                )}
              </td>
              <td className="px-8 py-6">
