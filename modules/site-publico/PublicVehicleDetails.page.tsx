    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="flex flex-col items-center gap-4">
          <div className="w-16 h-16 border-4 border-[#004691] border-t-transparent rounded-full animate-spin"></div>
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] animate-pulse">Carregando detalhes...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="lg:col-span-8 flex flex-col items-center space-y-6 overflow-hidden">
               ...
               <div className="relative group flex justify-center w-full">
                 <div 
                   ...
                   className="w-[380px] h-[350px] bg-slate-900 rounded-[3rem] overflow-hidden relative border-4 border-white cursor-zoom-in shadow-2xl shrink-0"
                 >
                    {activePhoto ? (
                      <img 
                        src={activePhoto} 
                  ...
                  <div className="flex gap-3 overflow-x-auto pb-4 pt-2 px-1 scrollbar-hide snap-x">
                    {sortedPhotos.map((foto, index) => (
                      <button 
                        ...
                        className={`relative min-w-[80px] h-[60px] rounded-xl overflow-hidden border-2 transition-all snap-start shrink-0 ${
                          activePhoto === foto.url ? 'border-[#004691] shadow-lg scale-105 z-10' : 'border-white opacity-40 hover:opacity-100'
                        }`}
                      >
                        <img src={foto.url} className="w-full h-full object-cover" alt={`Thumb ${index}`} />
                      </button>
                    ))}
                  </div>
               </div>
            ...
            <div className="lg:col-span-4">
               <div className="bg-white rounded-[3rem] border border-slate-200 p-8 shadow-2xl space-y-8 lg:sticky lg:top-28">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-5xl font-[900] text-[#004691] tracking-tighter">{formatCurrency(veiculo.valor_venda)}</p>
                  </div>
