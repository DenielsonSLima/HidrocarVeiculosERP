      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-10 space-y-4">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-slate-900 uppercase tracking-tighter leading-[0.9]">
            Quem <span className="text-[#004691]">Somos.</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch mb-20">
          ...
          <div className="relative w-full h-full min-h-[450px]">
            <div className="w-full h-full rounded-[2rem] overflow-hidden shadow-2xl ring-4 ring-slate-50">
              ...
              <img src={fachadaImg} className="w-full h-full object-cover" alt="Fachada Hidrocar Veículos" />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="relative bg-gradient-to-br from-[#004691] to-[#001d3d] p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-white/10 group overflow-hidden">
            {/* Ícone decorativo de fundo */}
            <svg className="absolute -right-6 -bottom-6 w-40 h-40 text-white/[0.04] group-hover:text-white/[0.07] transition-colors duration-500 rotate-12 group-hover:rotate-6" fill="currentColor" viewBox="0 0 24 24">
