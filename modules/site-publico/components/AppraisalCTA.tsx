      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="bg-white/10 backdrop-blur-3xl rounded-[3rem] p-12 md:p-20 border border-white/20 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-xl text-center md:text-left">
            ...
            <p className="text-lg text-white/70 font-medium leading-relaxed">Temos a melhor avaliação do mercado e o pagamento é à vista. Simples, rápido e com a segurança que só a HCV Veículos oferece.</p>
          </div>
