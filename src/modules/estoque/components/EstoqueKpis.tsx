...
const EstoqueKpis: React.FC<Props> = ({ veiculos }) => {
  const stats = useMemo(() => {
    const ativos = veiculos; // Pode filtrar por status se necessário (ex: remover vendidos)
